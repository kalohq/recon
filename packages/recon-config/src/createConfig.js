...
function createConfig(uc, {cwd = process.cwd()} = {}) {
  ...
  if (!rc) {
    throw new Error('Oops! Doesn\'t look like there is a valid .reconrc file defined in your project root. See: https://github.com/lystable/recon/tree/master/packages/recon-config for info.'); //
  }
